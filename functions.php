...
require_once($functions_path . '/components/pneus-component.php');
require_once($functions_path . '/components/modelos-component.php');
require_once($functions_path . '/components/insta-component.php');