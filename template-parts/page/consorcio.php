...
<section class="w-full md:pt-24 md:pb-10 py-10 pb-0">
    <div class="max-w-6xl mx-auto w-full">
        ...
        <div class="w-full flex md:flex-row flex-col-reverse relative">
            ...
            <div class="md:w-1/2 w-full flex md:justify-end justify-center items-center mb-5">
                <img src="<?php echo get_theme_image('escolha-consorcio.png ') ?>" class="w-full">
            </div>
...
<section class="w-full bg-blue-iveco py-20 px-5 md:px-0 md:mb-5">
    <div class="max-w-6xl mx-auto flex flex-col items-center justify-center">
        <h2
            ...
            Planeje seu futuro com quem entende de transporte.</h2>
