...
<section class="px-5 md:px-0 w-full py-16">
    <div class="max-w-6xl mx-auto w-full">
        <h2 class="text-blue-iveco font-inter md:text-xl text-base font-medium md:leading-[100%] leading-[24px] text-center">Na IVECO Florença, valorizamos cada cliente
