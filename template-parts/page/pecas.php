    ...
    <div class="max-w-6xl mx-auto w-full flex md:flex-row flex-col-reverse">
        <div class="md:w-1/2 w=full">
            ...
            <ul class="list-disc pl-5">
                <li class="text-black font-inter font-normal text-base mb-5">Ajuste preciso que evita desgastes
                    prematuros.</li>
                <li class="text-black font-inter font-normal text-base mb-5">Resistência para enfrentar qualquer desafio
                    na estrada.</li>
                <li class="text-black font-inter font-normal text-base mb-5">Menos paradas, mais eficiência na operação.
                </li>
                <li class="text-black font-inter font-normal text-base mb-5">Rigorosamente testadas e aprovadas pelos
                    padrões IVECO.</li>
                <li class="text-black font-inter font-normal text-base mb-5">Redução do risco de falhas mecânicas,
                    garantindo segurança total.</li>
            </ul>
        </div>
...
<section class="w-full pb-5 px-5 md:px-0">
    <div class="max-w-6xl mx-auto w-full flex md:flex-row flex-col">
        ...
        <div class="md:w-1/2 w-full md:pl-10">
            ...
            <p class="font-inter text-base font-normal mb-8">Desde a versatilidade da Daily até a força do S-Way, temos
                peças que garantem máxima performance para cada veículo.</p>
            <h3 class="font-inter font-medium text-3xl text-black mb-2">Peças NEXPRO</h3>
            <p class="font-inter text-base font-normal">Peças de reposição desenvolvidas para prolongar a vida útil do
                seu caminhão, mantendo a confiabilidade e a qualidade IVECO com excelente custo-benefício.</p>
        </div>
    </div>
</section>
<section class="w-full md:py-16 py-10 px-5 md:px-0">
